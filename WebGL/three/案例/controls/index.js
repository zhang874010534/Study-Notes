...
const basicType = {
  ...
  tube: getMeshValue('tube'),
  radialSegments: getMeshValue('radialSegments'),
  tubularSegments: getMeshValue('tubularSegments'),
  arc: getMeshValue('arc'),
  p: getMeshValue('p'),
  q: getMeshValue('q'),
  detail: getMeshValue('detail'),
}
