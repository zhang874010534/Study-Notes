...
const getDefaultCondition = () => {
  ...
  if (findTypeItem) {
    ...
    if (type === 1) {
      ...
      condition.endTime = dayjs().endOf('month').hour(23).minute(59).second(59).format('YYYY-MM-DD HH:mm:ss')
    } else if (type === 2) {
      // 季度
      condition.startTime = dayjs().subtract(1, 'quarter').startOf('quarter').hour(0).minute(0).second(0).format('YYYY-MM-DD HH:mm:ss')
      condition.endTime = dayjs().endOf('quarter').hour(23).minute(59).second(59).format('YYYY-MM-DD HH:mm:ss')
    } else if (type === 3) {
      // 年
      condition.startTime = dayjs().subtract(1, 'year').startOf('year').hour(0).minute(0).second(0).format('YYYY-MM-DD HH:mm:ss')
      condition.endTime = dayjs().endOf('year').hour(23).minute(59).second(59).format('YYYY-MM-DD HH:mm:ss')
    } else {
      // 自定义时间
...
const changeDatePicker = () => {
  ...
  if (condition.endTime) {
    if (selectType.value === 1) {
      // 月 月底
      endTime = dayjs(condition.endTime).endOf('month').hour(23).minute(59).second(59).format('YYYY-MM-DD HH:mm:ss')
      ...
      // 年 年底
      endTime = dayjs(condition.endTime).endOf('year').hour(23).minute(59).second(59).format('YYYY-MM-DD HH:mm:ss')
    } else {
      endTime = dayjs(condition.endTime).hour(23).minute(59).second(59).format('YYYY-MM-DD HH:mm:ss')
    }
  }
